...
#       print(e)
    ...
    #cv_image=cv2.imread("/home/dd/openvino_models/droneCOM/darknet/data/VOCdevkit2007/VOC2007/JPEGImages/1.jpg")
...
def detect(current_image):
    ...
    #   cv2.circle(current_image, (50,50), 10, 255)
    ...
    #cv2.imshow("window", getimg)
    #current_image=getimg.copy()
#########################################
...
########################################
    ...
    # try:
    #   self.image_pub.publish(self.bridge.cv2_to_imgmsg(current_image, "bgr8"))
    # except CvBridgeError as e:
    #   print(e)
